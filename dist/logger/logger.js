...
var name57 = "SkillCooldownNotify";
...
function read95(reader, version2) {
  const data = {};
  data.abilityDataList = reader.array(reader.u16(), () => read94(reader, version2), 100);
  return data;
}
...
var name58 = "AbilityChangeNotify";
...
function read97(reader, version2) {
  const data = {};
  data.activeAbilityList = reader.array(reader.u16(), () => read96(reader, version2), 60);
  data.objectId = reader.u64();
  return data;
}
...
var name59 = "ActiveAbilityNotify";
...
var name60 = "AddonSkillFeatureChangeNotify";
...
var name61 = "BlockSkillStateNotify";
...
var name62 = "CounterAttackNotify";
...
function read105(reader, version2) {
  ...
  data.statPair = reader.array(
    ...
    () => {
      ...
      h.Value = read19(reader, version2);
      return h;
    },
    152
  );
  data.name = reader.string(20);
  data.level = reader.u16();
  data.statusEffectDatas = reader.array(reader.u16(), () => read104(reader, version2), 80);
  data.characterId = reader.u64();
  data.gearLevel = reader.f32();
  data.playerId = reader.u64();
  data.classId = reader.u16();
...
function read106(reader, version2) {
  ...
  data.statPair = reader.array(
    ...
    () => {
      const l = {};
      l.statType = reader.u8();
      l.value = read19(reader, version2);
      return l;
    },
    152
  );
...
function read108(reader, version2) {
  ...
  data.statPair = reader.array(
    ...
    () => {
      ...
      x.value = read19(reader, version2);
      return x;
    },
    152
  );
...
function read109(reader, version2) {
  const data = {};
  data.npcStruct = read108(reader, version2);
  return data;
}
...
function read110(reader, version2) {
  ...
  data.publishReason = reader.u8();
  data.ownerId = reader.u64();
  data.npcData = read108(reader, version2);
  return data;
}
...
function read112(reader, version2) {
  ...
  data.statPair = reader.array(
    ...
    () => {
      ...
      z.value = read19(reader, version2);
      return z;
    },
    152
  );
  ...
  if (version2 >= 1) {
    data.avgItemLevel = reader.f32();
    data.position = read39(reader);
    data.equipItemDataList = reader.array(reader.u16(), () => read111(reader, version2), 32);
    data.equipLifeToolDataList = reader.array(reader.u16(), () => read111(reader, version2), 9);
    data.guildName = reader.string(20);
    if (version2 >= 2) {
      data.guildId = reader.u64();
    } else {
...
function read113(reader, version2) {
  const data = {};
  data.pcStruct = read112(reader, version2);
  return data;
}
...
function read115(reader, version2) {
  const data = {};
  data.projectileInfo = read114(reader, version2);
  return data;
}
function write31(writer, data) {
  write30(writer, data.projectileInfo);
}
var name72 = "NewProjectile";
...
var name73 = "ParalyzationStateNotify";

// src/packets/log/structures/PartyMemberData.ts
function read117(reader, version2) {
  const data = {};
  data.maxHp = read19(reader, version2);
  data.characterId = reader.u64();
  data.position = read39(reader, version2);
  data.transitIndex = reader.u32();
  data.curHp = read19(reader, version2);
  data.characterLevel = reader.u16();
  data.gearLevel = reader.f32();
  data.zoneId = reader.u32();
  data.partyMemberNumber = reader.u8();
...
function read118(reader, version2) {
  ...
  data.partyInstanceId = reader.u32();
  data.partyLootType = reader.u8();
  data.memberDatas = reader.array(reader.u16(), () => read117(reader, version2), 40);
  return data;
}
...
var name76 = "PartyPassiveStatusEffectAddNotify";
...
var name77 = "PartyPassiveStatusEffectRemoveNotify";
...
var name78 = "PartyStatusEffectAddNotify";
...
var name79 = "PartyStatusEffectRemoveNotify";
...
var name80 = "PartyStatusEffectResultNotify";
...
var name81 = "PassiveStatusEffectAddNotify";
...
var name82 = "PassiveStatusEffectRemoveNotify";
...
function read130(reader, version2) {
  const data = {};
  data.unpublishedObjects = reader.array(reader.u16(), () => read129(reader, version2), 200);
  return data;
}
...
function read131(reader, version2) {
  ...
  data.unk3_m = reader.u16();
  data.maxHp = read19(reader, version2);
  data.damage = read19(reader, version2);
  return data;
}
...
function read132(reader, version2) {
  ...
  data.position = read39(reader, version2);
  data.skillDamageEvent = read131(reader, version2);
  return data;
}
...
var name86 = "SkillDamageAbnormalMoveNotify";
...
function read134(reader, version2) {
  ...
  data.sourceId = reader.u64();
  data.skillId = reader.u32();
  data.skillDamageEvents = reader.array(reader.u16(), () => read131(reader, version2), 50);
  data.skillEffectId = reader.u32();
  return data;
}
...
function read136(reader, version2) {
  ...
  if (reader.bool())
    data.pitchRotation = read38(reader, version2);
  if (reader.bool())
    data.aiStateId = reader.u32();
...
var name90 = "StatusEffectAddNotify";
...
var name91 = "StatusEffectRemoveNotify";
...
var name92 = "StatusEffectDurationNotify";
...
var name93 = "StatusEffectSyncDataNotify";
...
var name94 = "TriggerBossBattleStatus";
...
var name95 = "TriggerFinishNotify";
...
var name97 = "TroopMemberUpdateMinNotify";
...
var name98 = "IdentityGaugeChangeNotify";
...
var name99 = "ZoneObjectUnpublishNotify";
...
function read148(reader, version2) {
  const data = {};
  data.zoneStatusEffectDataList = reader.array(reader.u16(), () => read147(reader, version2), 4);
  return data;
}
...
var name100 = "ZoneStatusEffectAddNotify";
...
var name101 = "ZoneStatusEffectRemoveNotify";
...
var name103 = "IdentityStanceChangeNotify";
...
var name105 = "EquipLifeToolChangeNotify";
...
function read155(reader, version2) {
  const data = {};
  data.itemDataList = reader.array(reader.u16(), () => read154(reader, version2), 80);
  data.storageType = reader.u8();
  return data;
}
...
function read157(reader, version2) {
  ...
  data.raidId = reader.u32();
  data.totalTime = reader.u64();
  data.bossKillDataList = reader.array(reader.u16(), () => read156(reader, version2), 3);
  data.endTick = reader.u64();
  data.startTick = reader.u64();
  return data;
}
...
var name108 = "ZoneMemberLoadStatusNotify";
...
function read160(reader, version2) {
  const data = {};
  data.trapData = read159(reader, version2);
  return data;
}
...
var name111 = "APP_StatApi";

// src/packets/log/logMapping.ts
var logMapping = /* @__PURE__ */ new Map([
  [101 /* SkillCooldownNotify */, [name57, read93, write9]],
  [0 /* AbilityChangeNotify */, [name58, read95, write11]],
  [1 /* ActiveAbilityNotify */, [name59, read97, write13]],
  [
    2 /* AddonSkillFeatureChangeNotify */,
    [name60, read98, write14]
  ],
  [
    4 /* BlockSkillStateNotify */,
    [name61, read99, write15]
  ],
  [5 /* CounterAttackNotify */, [name62, read100, write16]],
  [6 /* DeathNotify */, [name63, read101, write17]],
  [7 /* InitAbility */, [name64, read102, write18]],
  [8 /* InitEnv */, [name65, read103, write19]],
  [9 /* InitPC */, [name66, read105, write21]],
  [10 /* InitLocal */, [name67, read106, write22]],
  [11 /* MigrationExecute */, [name68, read107, write23]],
  [12 /* NewNpc */, [name69, read109, write25]],
  [13 /* NewNpcSummon */, [name70, read110, write26]],
  [14 /* NewPC */, [name71, read113, write29]],
  [15 /* NewProjectile */, [name72, read115, write31]],
  [
    16 /* ParalyzationStateNotify */,
    [name73, read116, write32]
  ],
  [17 /* PartyInfo */, [name74, read118, write34]],
  [18 /* PartyLeaveResult */, [name75, read119, write35]],
  [
  ...
  [26 /* RaidBossKillNotify */, [name83, read127, write43]],
  [27 /* RaidResult */, [name84, read128, write44]],
  [28 /* RemoveObject */, [name85, read130, write46]],
  [
    29 /* SkillDamageAbnormalMoveNotify */,
    [name86, read133, write49]
  ],
  [30 /* SkillDamageNotify */, [name87, read134, write50]],
  [31 /* SkillStageNotify */, [name88, read135, write51]],
  [32 /* SkillStartNotify */, [name89, read136, write52]],
  [
    34 /* StatusEffectAddNotify */,
    [name90, read137, write53]
  ],
  [
    35 /* StatusEffectRemoveNotify */,
    [name91, read138, write54]
  ],
  [
    36 /* StatusEffectDurationNotify */,
    [name92, read139, write55]
  ],
  [
    37 /* StatusEffectSyncDataNotify */,
    [name93, read140, write56]
  ],
  [
    38 /* TriggerBossBattleStatus */,
    [name94, read141, write57]
  ],
  [39 /* TriggerFinishNotify */, [name95, read142, write58]],
  [40 /* TriggerStartNotify */, [name96, read143, write59]],
  [
    41 /* TroopMemberUpdateMinNotify */,
    [name97, read144, write60]
  ],
  [
    42 /* IdentityGaugeChangeNotify */,
    [name98, read145, write61]
  ],
  [
    43 /* ZoneObjectUnpublishNotify */,
    [name99, read146, write62]
  ],
  [
    44 /* ZoneStatusEffectAddNotify */,
    [name100, read148, write64]
  ],
  [
    45 /* ZoneStatusEffectRemoveNotify */,
    [name101, read149, write65]
  ],
  [46 /* SkillCastNotify */, [name102, read150, write66]],
  [
    47 /* IdentityStanceChangeNotify */,
    [name103, read151, write67]
  ],
  [48 /* EquipChangeNotify */, [name104, read152, write68]],
  [
    49 /* EquipLifeToolChangeNotify */,
    [name105, read153, write69]
  ],
  [50 /* InitItem */, [name106, read155, write71]],
  [52 /* RaidBegin */, [name107, read157, write73]],
  [
    51 /* ZoneMemberLoadStatusNotify */,
    [name108, read158, write74]
  ],
  [53 /* NewTrap */, [name109, read160, write76]],
  [54 /* SkillCancelNotify */, [name110, read161, write77]],
  [6e4 /* APP_StatApi */, [name111, read162, write78]]
]);
